...
stdenv.mkDerivation {
  ...
  buildCommand = ''
    ...
    then
        ...
        yes "" | ${sdk}/bin/avdmanager create avd --force -n device -k "system-images;android-${platformVersion};${systemImageType};${abiVersion}" $NIX_ANDROID_AVD_FLAGS -p $ANDROID_AVD_HOME
